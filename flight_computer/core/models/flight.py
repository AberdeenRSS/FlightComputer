...
from flight_computer.core.models.command import CommandInfo, CommandInfoSchema
from flight_computer.core.models.flight_measurement import FlightMeasurementDescriptorSchema
