...
class CrashScreen(App):
    ...
    def build(self):
        ...
        if self.error:
            ...
            exception_label = Label(text=f'Uncaught exception, the app crashed without message',  shorten=False, font_size=16, valign='center' )
...
def async_io_main_with_crash_handling():
