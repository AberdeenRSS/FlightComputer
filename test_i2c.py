...
def parse_calib_data(reg_data):
    ...
    reg_par_p3 =  struct.unpack('<B', reg_data[9])
    temp_var = 4294967296.0
    quanpar_p3 = reg_par_p3 / temp_var
    reg_par_p4 =  struct.unpack('<B', reg_data[10])
